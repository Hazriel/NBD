...
class ForumController extends Controller
{
    ...
    public function create(Request $request, Category $category)
    {
        $this->validate($request, [
            ...
            'required_create_topic_power' => 'required|int|min:0',
            'required_update_topic_power' => 'required|int|min:0',
            'required_delete_topic_power' => 'required|int|min:0',
            'required_create_post_power' => 'required|int|min:0',
            'required_update_post_power' => 'required|int|min:0',
        ...
        Forum::create([
            ...
            'required_create_topic_power' => $input['required_create_post_power'],
            'required_update_topic_power' => $input['required_update_post_power'],
            'required_delete_topic_power' => $input['required_delete_post_power'],
            'required_create_post_power' => $input['required_create_comment_power'],
            'required_update_post_power' => $input['required_update_comment_power'],
            'required_delete_post_power' => $input['required_delete_comment_power'],
