...
class ForumController extends Controller
{
    ...
    public function create(Request $request, Category $category)
    {
        ...
        Forum::create([
            ...
            'required_create_topic_power' => $input['required_create_topic_power'],
            'required_update_topic_power' => $input['required_update_topic_power'],
            'required_delete_topic_power' => $input['required_delete_topic_power'],
            'required_create_post_power' => $input['required_create_post_power'],
            'required_update_post_power' => $input['required_update_post_power'],
